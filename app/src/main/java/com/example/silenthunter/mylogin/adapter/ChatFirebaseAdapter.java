package com.example.silenthunter.mylogin.adapter;
...
import static com.example.silenthunter.mylogin.R.id.email;
...
//        this.nameUser = "Asad" ;
    ...
    protected void populateViewHolder(MyChatViewHolder viewHolder, ChatModel model, int position) {
        ...
        if (model.getFile() != null){
            ...
            viewHolder.setIvChatPhoto(com.example.silenthunter.mylogin.util.Util.local(model.getMapModel().getLatitude(),model.getMapModel().getLongitude()));
